...
var AssetFemale3DCG = [
	...
	},
	{
		...
		Asset: [
			...
			{ Name: "XCrossChains", Value: -1, Difficulty: 12, SelfBondage: 5, Time: 5,  AllowLock: true, SetPose: ["OverTheHead", "Spread"], Prerequisite: ["CuffedArms", "CuffedFeet", "LegsOpen"], Block: ["ItemArms", "ItemFeet", "ItemLegs"], Effect:  ["Block"] }
		],
		Color: ["Default"]
	},
