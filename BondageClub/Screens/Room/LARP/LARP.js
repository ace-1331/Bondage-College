...
function LARPClick() {
	...
	if (!DailyJobSubSearchIsActive() && CommonIsClickAt(1000, 0, 500, 1000)) CharacterSetCurrent(LARPOrganiser);	
	...
	if (CommonIsClickAt(1885, 265, 90, 90) && (ReputationGet("LARP") >= 1) && (Player.Game != null) && (Player.Game.LARP != null) && (Player.Game.LARP.Class != null) && Player.CanChange()) {
