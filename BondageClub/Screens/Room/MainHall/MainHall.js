...
function MainHallRun() {
	...
	DrawButton(1765, 25, 90, 90, "", "White", "Icons/Dress.png", TextGet("Appearance"));
...
function MainHallClick() {
	...
	if ((MouseX >= 1765) && (MouseX < 1855) && (MouseY >= 25) && (MouseY < 115)) CharacterAppearanceLoadCharacter(Player);
