...
function CellClick() {
	...
	if (CellOpenTimer < CurrentTime) {
		...
		if (CommonIsClickAt(1885, 265, 90, 90)) CellLock(CellMinutes);
		if (CommonIsClickAt(1885, 385, 90, 90) && (CellMinutes < 60)) CellMinutes = CellMinutes + 5;
		if (CommonIsClickAt(1885, 505, 90, 90) && (CellMinutes > 5)) CellMinutes = CellMinutes - 5;
		if (CommonIsClickAt(1885, 625, 90, 90)) CharacterSetCurrent(CellKeyDepositStaff);
	}
}
