...
function InventoryItemLegsDuctTapeClick() {
	...
	if (CommonIsClickAt(1000, 550, 225, 225) && (DialogFocusItem.Property != null)) InventoryItemLegsDuctTapeSetPose(null);
	if (CommonIsClickAt(1250, 550, 225, 225) && ((DialogFocusItem.Property == null) || (DialogFocusItem.Property.Type != "HalfLegs"))) InventoryItemLegsDuctTapeSetPose("HalfLegs");
	if (CommonIsClickAt(1500, 550, 225, 225) && ((DialogFocusItem.Property == null) || (DialogFocusItem.Property.Type != "MostLegs"))) InventoryItemLegsDuctTapeSetPose("MostLegs");
	if (CommonIsClickAt(1750, 550, 225, 225) && ((DialogFocusItem.Property == null) || (DialogFocusItem.Property.Type != "CompleteLegs"))) InventoryItemLegsDuctTapeSetPose("CompleteLegs");
}
