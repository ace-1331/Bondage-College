...
function InventoryItemLegsOrnateLegCuffsClick() {
	...
	if (CommonIsClickAt(1250, 550, 1475-1250, 775-550) && (DialogFocusItem.Property.Restrain != null)) InventoryItemLegsOrnateLegCuffsSetPose(null);
	if (CommonIsClickAt(1500, 550, 1725-1500, 775-550) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "Closed"))) InventoryItemLegsOrnateLegCuffsSetPose("Closed");
}
