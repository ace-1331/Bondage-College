...
function InventoryItemArmsSturdyLeatherBeltsClick() {
	if (!InventoryItemHasEffect(DialogFocusItem, "Lock", true)) {
		...
		if (CommonIsClickAt(1125, 550, 225, 225) && (DialogFocusItem.Property.Restrain != null)) InventoryItemArmsSturdyLeatherBeltsSetPose(null);
		if (CommonIsClickAt(1375, 550, 225, 225) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "Two"))) InventoryItemArmsSturdyLeatherBeltsSetPose("Two");
		if (CommonIsClickAt(1625, 550, 225, 225) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "Three"))) InventoryItemArmsSturdyLeatherBeltsSetPose("Three");
	} else return
}
