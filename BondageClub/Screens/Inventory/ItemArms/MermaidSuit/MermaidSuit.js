...
function InventoryItemArmsMermaidSuitClick() {
	...
	if (CommonIsClickAt(1150, 440, 1375-1150, 665-440) && (DialogFocusItem.Property.Type != null)) InventoryItemArmsMermaidSuitSetType(null);
	if (CommonIsClickAt(1600, 440, 1825-1600, 665-440) && ((DialogFocusItem.Property.Type == null) || (DialogFocusItem.Property.Type != "UnZip"))) InventoryItemArmsMermaidSuitSetType("UnZip");
	var C = (Player.FocusGroup != null) ? Player : CurrentCharacter;
}
