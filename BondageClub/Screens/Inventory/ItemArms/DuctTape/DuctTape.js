...
function InventoryItemArmsDuctTapeClick() {
	...
	if (CommonIsClickAt(1375, 450, 225, 225) && ((DialogFocusItem.Property == null) || (DialogFocusItem.Property.Restrain != "Bottom"))) InventoryItemArmsDuctTapeSetPose("Bottom");
	...
	if (CommonIsClickAt(1150, 750, 225, 225) && ((DialogFocusItem.Property == null) || (DialogFocusItem.Property.Restrain != "Full"))) InventoryItemArmsDuctTapeSetPose("Full");
	if (CommonIsClickAt(1600, 750, 225, 225) && ((DialogFocusItem.Property == null) || (DialogFocusItem.Property.Restrain != "Complete"))) InventoryItemArmsDuctTapeSetPose("Complete");
}
