...
function InventoryItemArmsBitchSuitClick() {
	...
	if (CommonIsClickAt(1150, 440, 1375-1150, 225) && (DialogFocusItem.Property.Type != null)) InventoryItemArmsBitchSuitSetType(null);
	if (CommonIsClickAt(1600, 440, 1825-1600, 225) && ((DialogFocusItem.Property.Type == null) || (DialogFocusItem.Property.Type != "UnZip"))) InventoryItemArmsBitchSuitSetType("UnZip");
	var C = (Player.FocusGroup != null) ? Player : CurrentCharacter;
}
