...
function InventoryItemArmsBitchSuitClick() {
	...
	if (CommonIsClickAt(1150, 440, 225, 225) && (DialogFocusItem.Property.Type != null)) InventoryItemArmsBitchSuitSetType(null);
	if (CommonIsClickAt(1600, 440, 225, 225) && ((DialogFocusItem.Property.Type == null) || (DialogFocusItem.Property.Type != "UnZip"))) InventoryItemArmsBitchSuitSetType("UnZip");
	var C = (Player.FocusGroup != null) ? Player : CurrentCharacter;
}
