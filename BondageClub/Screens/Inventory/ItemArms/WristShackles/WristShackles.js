...
function InventoryItemArmsWristShacklesClick() {
	...
	if (CommonIsClickAt(1250, 550, 225, 225) && (DialogFocusItem.Property.Restrain != null)) InventoryItemArmsWristShacklesSetPose(null);
	if (CommonIsClickAt(1500, 550, 225, 225) && (DialogFocusItem.Property.Restrain == null)) InventoryItemArmsWristShacklesSetPose("Behind");
}
