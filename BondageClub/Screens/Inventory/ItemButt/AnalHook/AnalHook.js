...
function InventoryItemButtAnalHookClick() {
	...
	if (CommonIsClickAt(1000, 550, 225, 225) && (DialogFocusItem.Property.Restrain != null)) InventoryItemButtAnalHookSetPose(null);
	if (CommonIsClickAt(1250, 550, 225, 225) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "Chain"))) InventoryItemButtAnalHookSetPose("Chain");
	if (CommonIsClickAt(1500, 550, 225, 225) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "Hair"))) InventoryItemButtAnalHookSetPose("Hair");
}
