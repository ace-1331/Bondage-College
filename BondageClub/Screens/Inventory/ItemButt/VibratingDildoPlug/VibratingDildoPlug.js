...
function InventoryItemButtVibratingDildoPlugClick() {
	...
	if (CommonIsClickAt(1550, 650, 1750-1550, 705-650) && (DialogFocusItem.Property.Intensity > 0)) InventoryItemButtVibratingDildoPlugSetIntensity(0 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1200, 710, 1400-1200, 765-710) && (DialogFocusItem.Property.Intensity < 1)) InventoryItemButtVibratingDildoPlugSetIntensity(1 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1200, 710, 1400-1200, 765-710) && (DialogFocusItem.Property.Intensity > 1)) InventoryItemButtVibratingDildoPlugSetIntensity(1 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1550, 710, 1750-1550, 765-710) && (DialogFocusItem.Property.Intensity > 2)) InventoryItemButtVibratingDildoPlugSetIntensity(2 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1550, 710, 1750-1550, 765-710) && (DialogFocusItem.Property.Intensity < 2)) InventoryItemButtVibratingDildoPlugSetIntensity(2 - DialogFocusItem.Property.Intensity);
