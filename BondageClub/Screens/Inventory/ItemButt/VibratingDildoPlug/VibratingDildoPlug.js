...
function InventoryItemButtVibratingDildoPlugClick() {
	...
	if (CommonIsClickAt(1200, 650, 200, 55) && (DialogFocusItem.Property.Intensity > -1)) InventoryItemButtVibratingDildoPlugSetIntensity(-1 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1550, 650, 200, 55) && (DialogFocusItem.Property.Intensity < 0)) InventoryItemButtVibratingDildoPlugSetIntensity(0 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1550, 650, 200, 55) && (DialogFocusItem.Property.Intensity > 0)) InventoryItemButtVibratingDildoPlugSetIntensity(0 - DialogFocusItem.Property.Intensity);
