...
function InventoryItemMouth2ClothGagClick() {
	...
	if (CommonIsClickAt(1000, 550, 225, 225) && (DialogFocusItem.Property.Type != null)) InventoryItemMouth2ClothGagSetType(null);
//	if (CommonIsClickAt(1250, 550, 225, 225) && ((DialogFocusItem.Property.Type == null) || (DialogFocusItem.Property.Type != "Cleave"))) InventoryItemMouth2ClothGagSetType("Cleave");
	if (CommonIsClickAt(1500, 550, 225, 225) && ((DialogFocusItem.Property.Type == null) || (DialogFocusItem.Property.Type != "OTM"))) InventoryItemMouth2ClothGagSetType("OTM");
	if (CommonIsClickAt(1750, 550, 225, 225) && ((DialogFocusItem.Property.Type == null) || (DialogFocusItem.Property.Type != "OTN"))) InventoryItemMouth2ClothGagSetType("OTN");
}
