...
function InventoryItemVulvaFullLatexSuitWandClick() {
	...
	if (CommonIsClickAt(1200, 650, 200, 55) && (DialogFocusItem.Property.Intensity > -1)) InventoryItemVulvaFullLatexSuitWandSetIntensity(-1 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1550, 650, 200, 55) && (DialogFocusItem.Property.Intensity < 0)) InventoryItemVulvaFullLatexSuitWandSetIntensity(0 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1550, 650, 200, 55) && (DialogFocusItem.Property.Intensity > 0)) InventoryItemVulvaFullLatexSuitWandSetIntensity(0 - DialogFocusItem.Property.Intensity);
