...
function InventoryItemVulvaClitSuctionCupClick() {
	...
	if (CommonIsClickAt(1550, 650, 1750-1550, 705-650) && (DialogFocusItem.Property.SuctionLevel > 1)) InventoryItemVulvaClitSuctionCupIntensity(1 - DialogFocusItem.Property.SuctionLevel);
	if (CommonIsClickAt(1200, 710, 1400-1200, 765-710) && (DialogFocusItem.Property.SuctionLevel < 2)) InventoryItemVulvaClitSuctionCupIntensity(2 - DialogFocusItem.Property.SuctionLevel);
	if (CommonIsClickAt(1200, 710, 1400-1200, 765-710) && (DialogFocusItem.Property.SuctionLevel > 2)) InventoryItemVulvaClitSuctionCupIntensity(2 - DialogFocusItem.Property.SuctionLevel);
	if (CommonIsClickAt(1550, 710, 1750-1550, 765-710) && (DialogFocusItem.Property.SuctionLevel > 3)) InventoryItemVulvaClitSuctionCupIntensity(3 - DialogFocusItem.Property.SuctionLevel);
	if (CommonIsClickAt(1550, 710, 1750-1550, 765-710) && (DialogFocusItem.Property.SuctionLevel < 3)) InventoryItemVulvaClitSuctionCupIntensity(3 - DialogFocusItem.Property.SuctionLevel);
