...
function InventoryItemNipplesPiercingsRoundPiercingClick() {
	...
	if (CommonIsClickAt(1000, 550, 225, 225) && (DialogFocusItem.Property != null)) InventoryItemNipplesPiercingsRoundPiercingSetPose(null);
	if (CommonIsClickAt(1250, 550, 225, 225) && ((DialogFocusItem.Property == null) || (DialogFocusItem.Property.Type != "Chain"))) InventoryItemNipplesPiercingsRoundPiercingSetPose("Chain");
}
