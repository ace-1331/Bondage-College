...
function InventoryItemHeadNoseRingClick() {
	...
	if (CommonIsClickAt(1000, 550, 1225-1000, 775-550) && (DialogFocusItem.Property.Restrain != null)) InventoryItemHeadNoseRingSetPose(null);
	if (CommonIsClickAt(1250, 550, 1475-1250, 775-550) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "ChainShort")) && ChainShortPrerequisites) InventoryItemHeadNoseRingSetPose("ChainShort");
	if (CommonIsClickAt(1500, 550, 1725-1500, 775-550) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "ChainLong"))) InventoryItemHeadNoseRingSetPose("ChainLong");
	if (CommonIsClickAt(1750, 550, 1975-1750, 775-550) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "Leash"))) InventoryItemHeadNoseRingSetPose("Leash");
}
