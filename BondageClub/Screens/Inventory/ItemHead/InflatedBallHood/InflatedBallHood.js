...
function InventoryItemHeadInflatedBallHoodClick() {
	...
	if (CommonIsClickAt(1885, 25, 90, 85)) DialogFocusItem = null;
	if (CommonIsClickAt(1200, 650, 200, 55) && (DialogFocusItem.Property.PumpLevel > 0)) InventoryItemHeadInflatedBallHoodSetPump(0 - DialogFocusItem.Property.PumpLevel);
	if (CommonIsClickAt(1550, 650, 200, 55) && (DialogFocusItem.Property.PumpLevel < 1)) InventoryItemHeadInflatedBallHoodSetPump(1 - DialogFocusItem.Property.PumpLevel);
	if (CommonIsClickAt(1550, 650, 200, 55) && (DialogFocusItem.Property.PumpLevel > 1)) InventoryItemHeadInflatedBallHoodSetPump(1 - DialogFocusItem.Property.PumpLevel);
