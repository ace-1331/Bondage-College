...
function InventoryItemNipplesTapedVibeEggsClick() {
	...
	if (CommonIsClickAt(1200, 650, 1400-1200, 705-650) && (DialogFocusItem.Property.Intensity > -1)) InventoryItemNipplesTapedVibeEggsSetIntensity(-1 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1550, 650, 1750-1550, 705-650) && (DialogFocusItem.Property.Intensity < 0)) InventoryItemNipplesTapedVibeEggsSetIntensity(0 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1550, 650, 1750-1550, 705-650) && (DialogFocusItem.Property.Intensity > 0)) InventoryItemNipplesTapedVibeEggsSetIntensity(0 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1200, 710, 1400-1200, 765-710) && (DialogFocusItem.Property.Intensity < 1)) InventoryItemNipplesTapedVibeEggsSetIntensity(1 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1200, 710, 1400-1200, 765-710) && (DialogFocusItem.Property.Intensity > 1)) InventoryItemNipplesTapedVibeEggsSetIntensity(1 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1550, 710, 1750-1550, 765-710) && (DialogFocusItem.Property.Intensity > 2)) InventoryItemNipplesTapedVibeEggsSetIntensity(2 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1550, 710, 1750-1550, 765-710) && (DialogFocusItem.Property.Intensity < 2)) InventoryItemNipplesTapedVibeEggsSetIntensity(2 - DialogFocusItem.Property.Intensity);
	if (CommonIsClickAt(1375, 770, 1575-1375, 825-770) && (DialogFocusItem.Property.Intensity < 3)) InventoryItemNipplesTapedVibeEggsSetIntensity(3 - DialogFocusItem.Property.Intensity);
}
