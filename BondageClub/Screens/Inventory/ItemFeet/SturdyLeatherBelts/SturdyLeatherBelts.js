...
function InventoryItemFeetSturdyLeatherBeltsClick() {
	if (!InventoryItemHasEffect(DialogFocusItem, "Lock", true)) {
		...
		if (CommonIsClickAt(1125, 550, 225, 225) && (DialogFocusItem.Property.Restrain != null)) InventoryItemFeetSturdyLeatherBeltsSetPose(null);
		if (CommonIsClickAt(1375, 550, 225, 225) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "Two"))) InventoryItemFeetSturdyLeatherBeltsSetPose("Two");
		if (CommonIsClickAt(1625, 550, 225, 225) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "Three"))) InventoryItemFeetSturdyLeatherBeltsSetPose("Three");
	} else return
}
