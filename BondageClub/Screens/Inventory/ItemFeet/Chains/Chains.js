...
function InventoryItemFeetChainsClick() {
	...
	if (CommonIsClickAt(1050, 550, 1275-1050, 775-550) && (DialogFocusItem.Property.Type != null)) InventoryItemFeetChainsSetType(null);
	if (CommonIsClickAt(1387, 550, 1612-1387, 775-550) && ((DialogFocusItem.Property.Type == null) || (DialogFocusItem.Property.Type != "Strict")) && (SkillGetLevelReal(Player, "Bondage") >= 2)) InventoryItemFeetChainsSetType("Strict");
	if (CommonIsClickAt(1725, 550, 1950-1725, 775-550) && ((DialogFocusItem.Property.Type == null) || (DialogFocusItem.Property.Type != "Suspension")) && (SkillGetLevelReal(Player, "Bondage") >= 6)) InventoryItemFeetChainsSetType("Suspension");
}
