...
function InventoryItemMouthClothGagClick() {
	...
	if (CommonIsClickAt(1000, 550, 225, 225) && (DialogFocusItem.Property.Type != null)) InventoryItemMouthClothGagSetType(null);
	if (CommonIsClickAt(1250, 550, 225, 225) && ((DialogFocusItem.Property.Type == null) || (DialogFocusItem.Property.Type != "Cleave"))) InventoryItemMouthClothGagSetType("Cleave");
	if (CommonIsClickAt(1500, 550, 225, 225) && ((DialogFocusItem.Property.Type == null) || (DialogFocusItem.Property.Type != "OTM"))) InventoryItemMouthClothGagSetType("OTM");
	if (CommonIsClickAt(1750, 550, 225, 225) && ((DialogFocusItem.Property.Type == null) || (DialogFocusItem.Property.Type != "OTN"))) InventoryItemMouthClothGagSetType("OTN");
}
