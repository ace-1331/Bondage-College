...
function InventoryItemMouthDildoPlugGagClick() {
	...
	if (CommonIsClickAt(1175, 550, 225, 225) && (DialogFocusItem.Property.Type != null)) InventoryItemMouthDildoPlugGagSetType(null);
	if (CommonIsClickAt(1600, 550, 225, 225) && ((DialogFocusItem.Property.Type == null) || (DialogFocusItem.Property.Type != "Plug"))) InventoryItemMouthDildoPlugGagSetType("Plug");
}
